...
from jms.client.v1.router import LabelRouter


class Label(base.BaseResource):
    def __str__(self):
...
class LabelManager(base.BaseManager):
    resource_class = Label

    def __init__(self, api_client):
        router = LabelRouter(self)
