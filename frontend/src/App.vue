    ...
    <el-container class="tac">
      ...
      <el-main class="content">
        ...
        <div v-show="activeIndex !== 'settings'">
          ...
          <a :href="resultUrl" class="btn result">
            <el-button type="success" :disabled="resultUrl === ''" >下载结果</el-button>
          </a>
        </div>
      </el-main>
    </el-container>
...
export default {
  ...
  methods: {
    ...
    handleMenuSelect(index) {
      ...
      // 获取缓存的结果文件下载地址
      this.resultUrl = this.resultUrlMap[index]
    },
    onSubmit() {
    ...
    handleUploadSuccess(response, file, fileList) {
      ...
      if (response.code === 200) {
        ...
        this.resultUrlMap[this.activeIndex] = this.baseUrl + `/api/result/${response.data.filename}`
        this.resultUrl = this.resultUrlMap[this.activeIndex]
        this.$message({
          type: 'success',
